...
RSpec.describe StatTracker do
  ...
  describe "#highest_total_score" do
    xit 'returns the highest total score in a game through all seasons' do
  ...
  describe "#loweest_total_score" do
    xit 'returns the lowest total score in a game through all seasons' do
  ...
  describe "#total_games_played" do
    xit 'returns the total number of games played across all seasons' do
  ...
  describe "#percentage_home_wins" do
    xit 'returns the percentage of games that a home team won, to the nearest hundreth' do
  ...
  describe "#percentage_visitor_wins" do
    xit 'returns the percentage of games that a visiting team won, to the nearest hundreth' do
  ...
  describe "#percentage_ties" do
    xit 'returns the percentage of games that ended in a tie, to the nearest hundreth' do
  ...
  describe "#count_of_games_by_season" do
    xit 'returns a hash with each season and its game count' do
      expectation = {
        "20122013"=>806, 
        "20162017"=>1317, 
        "20142015"=>1319, 
  ...
  describe "#average_goals_per_game" do
    xit 'returns the average goals made per game across all seasons' do
  ...
  describe "#average_goals_by_season" do
    xit 'returns a hash with the average goals made per game by season' do
      expectation = {
        "20122013"=>4.12, 
        "20162017"=>4.23, 
        "20142015"=>4.14, 
  ...
  describe '#best_offense' do
    xit 'returns the team with the most average goals scored' do
      expect(stat_tracker.best_offense).to eq "Reign FC"
    end
  end

  describe '#worst_offense' do
    xit 'returns the team with the least average goals scored' do
      expect(stat_tracker.worst_offense).to eq "Utah Royals FC"
    end
  end

  describe '#highest_scoring_home_team' do
    xit 'returns the home team with the highest average score per game' do
      expect(stat_tracker.highest_scoring_home_team).to eq "Reign FC"
    end
  end
  
  describe '#lowest_scoring_home_team' do
    xit 'returns the home team with the lowest average score per game' do
      expect(stat_tracker.lowest_scoring_home_team).to eq "Utah Royals FC"
    end
  end

  describe '#highest_scoring_visitor' do
    xit 'returns the visitor with the highest average score per game' do
      expect(stat_tracker.highest_scoring_visitor).to eq "FC Dallas"
    end
  end

  describe '#lowest_scoring_visitor' do
    xit 'returns the visitor with the lowest average score per game' do
